    ...
    <Fragment>
      <Head>
        ...
        <meta
          ...
          content="Be a DeFi Chef with Summit. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.sushi.com/icons/icon-192x192.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@SummitSwap" />
